    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            <h2 className="text-3xl font-bold tracking-[-0.04em] text-[#1d1d1f]">Get in Touch</h2>
            <div className="mt-6 space-y-4">
              {[
                { icon: Mail, title: "Email Us", value: "official.smellsfromheaven@gmail.com", href: "mailto:official.smellsfromheaven@gmail.com" },
                { icon: Phone, title: "Call Us", value: "+91 8087568338", href: "tel:+918087568338" },
                { icon: MessageCircle, title: "WhatsApp", value: "+91 8087568338", href: "https://wa.me/918087568338" },
                { icon: MapPin, title: "Office", value: "123 Fragrance Lane, Bandra West, Mumbai 400050", href: "#" },
                { icon: Clock, title: "Support Hours", value: "Mon–Sat: 9 AM – 7 PM IST", href: "#" },
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-[#6e6e73]">{value}</p>
                  </div>
                </a>
              ))}
            </div>
            ...
            <div className="mt-8 flex h-56 items-center justify-center overflow-hidden rounded-xl border border-[#e5e5e5] bg-[#f5f5f7]">
              <div className="text-center text-[#6e6e73]">
                <MapPin size={32} className="mx-auto mb-2 text-[#bf4800]" />
                <p className="font-medium text-[#1d1d1f]">123 Fragrance Lane</p>
          ...
          <div className="rounded-xl border border-[#e5e5e5] bg-[#f5f5f7] p-6 sm:p-8">
            <h2 className="text-3xl font-bold tracking-[-0.04em] text-[#1d1d1f]">Send a Message</h2>
            <form onSubmit={handleSubmit} className="mt-6 space-y-5" aria-label="Contact form">
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label htmlFor="name" className="mb-1.5 block text-sm font-medium text-[#1d1d1f]">Your Name *</label>
                  <input
                    id="name"
                    type="text"
                    required
                ...
                <div>
                  <label htmlFor="email" className="mb-1.5 block text-sm font-medium text-[#1d1d1f]">Email Address *</label>
                  <input
                    id="email"
                    type="email"
                    required
              ...
              <div>
                <label htmlFor="subject" className="mb-1.5 block text-sm font-medium text-[#1d1d1f]">Subject *</label>
                <select
                  id="subject"
                  value={form.subject}
              ...
              <div>
                <label htmlFor="message" className="mb-1.5 block text-sm font-medium text-[#1d1d1f]">Message *</label>
                <textarea
                  id="message"
                  rows={5}
                  required
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex w-full items-center justify-center gap-2 rounded-full bg-[#0066cc] px-6 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-[#0077ed] disabled:opacity-60"
              >
                {loading ? (
