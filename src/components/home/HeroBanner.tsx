    ...
    <section className="relative isolate overflow-hidden bg-[#faf8f3] text-[#111111]">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-4 py-14 max-[639px]:gap-3 max-[639px]:py-8 sm:px-6 lg:grid-cols-[0.96fr_1.04fr] lg:gap-10 lg:py-20">
        <div className="max-w-xl">
          {/* Brand Intro */}
          <p className="mb-4 text-[10px] font-semibold uppercase tracking-[0.28em] text-[#b88932] sm:text-[11px]">
            WELCOME TO HEAVEN
          </p>
          ...
          <h1 className="font-[var(--font-playfair)] text-5xl font-semibold leading-[0.9] tracking-[-0.07em] text-[#111111] sm:text-6xl lg:text-[5.3rem]">
            ...
            <span className="block">SCENT FEELS</span>
            <span className="block">LIKE HEAVEN.</span>
          </h1>

          {/* Description */}
          <p className="mt-5 max-[639px]:mt-4 max-w-lg text-lg leading-7 text-[#4d4d4d] sm:text-xl">
          ...
          <div className="mt-8 max-[639px]:mt-6 flex flex-wrap items-center gap-3.5">
            <Link
              href="/shop"
              className="inline-flex items-center justify-center rounded-full bg-[#111111] px-6 py-3 text-[11px] font-semibold uppercase tracking-[0.18em] text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#1d1d1d]"
            >
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-full border border-[#d9c8a2] bg-white/80 px-6 py-3 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#111111] transition-all duration-200 hover:-translate-y-0.5 hover:border-[#b88932] hover:text-[#b88932]"
            >
              FIND YOUR SCENT
            </Link>
          </div>
          ...
          {/* Live Visitor Count */}
          <div className="mt-5 max-[639px]:mt-4">
            <LiveVisitors />
          </div>

          {/* Brand Signature */}
          <div className="mt-9 max-[639px]:mt-6 text-[10px] font-semibold uppercase tracking-[0.22em] text-[#4d4d4d]">
