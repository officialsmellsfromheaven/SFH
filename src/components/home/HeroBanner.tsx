...
export default function HeroBanner() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#faf8f3] text-[#111111]">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-4 py-14 sm:px-6 lg:grid-cols-[0.96fr_1.04fr] lg:gap-10 lg:py-20">
        <div className="max-w-xl">
          <p className="text-[11px] font-semibold uppercase tracking-[0.26em] text-[#b88932]">SMELLS FROM HEAVEN</p>
          <h1 className="mt-5 font-[var(--font-playfair)] text-5xl font-semibold leading-[0.9] tracking-[-0.07em] text-[#111111] sm:text-6xl lg:text-[5.3rem]">
            <span className="block">FIND YOUR</span>
            <span className="block">SIGNATURE.</span>
          </h1>
          <p className="mt-5 max-w-lg text-lg leading-7 text-[#4d4d4d] sm:text-xl">Fragrance that feels uniquely you.</p>
          ...
          <div className="mt-9 flex items-center gap-3 text-[10px] font-semibold uppercase tracking-[0.22em] text-[#4d4d4d]">
        ...
        <div className="relative z-10 flex items-center justify-end pointer-events-none">
          <div className="relative h-[60vh] w-full max-w-[760px] sm:h-[74vh] sm:max-w-[920px] md:h-[86vh] md:max-w-[1080px] lg:h-[96vh] lg:max-w-[1240px] xl:h-[110vh] xl:max-w-[1400px] lg:translate-y-8 xl:-translate-y-5 lg:scale-[1.08] xl:scale-[1.12]">
            <Image
