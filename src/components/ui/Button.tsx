...
const variants = {
  primary:
    "bg-amber-600 hover:bg-amber-700 text-white font-bold shadow-lg transition-colors duration-200",
  secondary:
    "bg-[#0071e3] hover:bg-[#0077ed] text-white font-bold shadow-md transition-colors",
  outline:
